...
PRINT N'Creating lakeflowUtilityVersion_1_5 function...';
EXEC sp_executesql N'
CREATE FUNCTION dbo.lakeflowUtilityVersion_1_5()
RETURNS NVARCHAR(10)
AS
BEGIN
    RETURN ''1.5'';
END';
PRINT N'Created lakeflowUtilityVersion_1_5 function';
...
BEGIN
    ...
    DECLARE @ErrorMessage NVARCHAR(4000);
    DECLARE @SQL NVARCHAR(MAX);
    DECLARE @versionSuffix NVARCHAR(10) = ''_1_5'';
    ...
    BEGIN TRY
        ...
        BEGIN
            ...
            BEGIN TRAN
                ...
                IF @oldCaptureInstance IS NOT NULL AND (@oldCaptureInstance LIKE ''''lakeflow[_]%[_][1-2]'''' OR @oldCaptureInstance LIKE ''''New[_]%[_]%'''')
                BEGIN
...
BEGIN
    ...
    DECLARE @Platform NVARCHAR(50) = dbo.lakeflowDetectPlatform();
    PRINT N'Platform: ' + @Platform;
    PRINT N'Version: ' + dbo.lakeflowUtilityVersion_1_5();
    ...
    IF OBJECT_ID('dbo.lakeflowUtilityVersion_1_5', 'FN') IS NOT NULL
        PRINT N'✓ lakeflowUtilityVersion_1_5 function created successfully'
    ELSE
        PRINT N'✗ lakeflowUtilityVersion_1_5 function creation failed';
